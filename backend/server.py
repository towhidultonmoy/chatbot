...
#     }
# }
# def speak(text: str, profile: str, save: bool = False) -> bytes:
#     if play_speech:
...
#         speak(msg, profile="Empathetic", save=False)
...
def handle_input():
    try:
        ...
        result = Runner.run_sync(nutrition_agent_dynamic, user_text, context=user_profile)
        msg = result.final_output
        audio = speak(msg, profile="Empathetic")

        return jsonify({"response": msg, "audio": base64.b64encode(audio).decode('utf-8')})
