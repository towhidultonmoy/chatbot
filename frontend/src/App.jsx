import React, { useState, useRef, useEffect } from 'react';
   ...
   function EliaApp() {
     ...
     // Use Vite environment variable or fallback to EC2 public IP (HTTP for backend)
     ...
     const handleTextSubmit = async () => {
       ...
       try {
         ...
         setMessages([...messages, { user: 'You', text: input, time: timestamp }, { user: 'ELIA', text: `Error: ${error.message}`, time: now.toLocaleTimeString('en-US', { hour: '2-digit', minute: '2-digit', hour12: true }) }]);
       }
     };
