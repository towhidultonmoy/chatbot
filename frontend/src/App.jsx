import React, { useState, useRef, useEffect } from 'react';
     ...
     function EliaApp() {
       ...
       const handleTextSubmit = async () => {
         ...
         try {
           const response = await axios.post('/text', { text: input }); // Use relative URL
       ...
       const handleVoiceInput = async () => {
         ...
         try {
           ...
           mediaRecorder.onstop = async () => {
             ...
             try {
               const response = await axios.post('/text', { text: 'Voice input (mock)' }); // Use relative URL
       ...
       const handleImageUpload = async (event) => {
         ...
         if (file) {
           ...
           try {
             const response = await axios.post('/text', formData); // Use relative URL
