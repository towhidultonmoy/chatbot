...
function EliaApp() {
  ...
  useEffect(() => {
    ...
    if (!isChatVisible) {
      ...
      // Play audio for initial messages
      playAudio(speak("Hello, Ryan! I’m ELIA, your professional health companion. Ready to optimize your wellness journey? Ask me about exercises, diet, or upload an image for advice. Let’s get started!", "Empathetic"));
    }
  }, [isChatVisible]);
